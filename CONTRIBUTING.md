...
Welcome to `carlosversity` contributor's guide.
...
If you experience bugs or general issues with `carlosversity`, please have a look
...
You can help improve `carlosversity` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`carlosversity` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `carlosversity`'s files. While this mechanism can
...
```
conda create -n carlosversity python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/carlosversity.git
   cd carlosversity
   ```
...
5. Install [pre-commit]:
   ...
   `carlosversity` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/carlosversity
[issue tracker]: https://github.com/<USERNAME>/carlosversity/issues
